...
} from "@/features/admin/promotions/api/admin-promotions-service";
import { useAuthStore } from "@/features/auth/store/auth.store";
import { adminPromotionsQueryKey, adminPromotionsQueryScope } from "@/features/admin/promotions/hooks/admin-promotions-query";
