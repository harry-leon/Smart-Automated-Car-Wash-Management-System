...
import { useCustomerLogin, useCustomerRegister, useSendCustomerOtp, useVerifyCustomerOtp } from "@/hooks/use-auth";
import { getDisplayErrorMessage } from "@/lib/api-errors";
import { getAuthRedirectPath } from "@/lib/auth-session";
import { getLoginIdentifierValidationMessage, normalizeLoginIdentifier } from "@/lib/login-identifier";
import { getPasswordVisibilityState } from "@/lib/password-visibility";
import { cn } from "@/lib/utils";
import { emailPattern, otpPattern, passwordPattern, phonePattern } from "@/lib/validators";
