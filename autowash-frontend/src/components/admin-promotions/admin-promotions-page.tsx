        ...
        <Card className="border-slate-200 bg-white">
          <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <CardDescription>
                Manage promotion campaigns with real admin APIs and tier targeting rules.
              </CardDescription>
            </div>
            <Button
              type="button"
        ...
        <div className="grid gap-6 xl:grid-cols-[420px_minmax(0,1fr)]">
          <Card className="border-slate-200 bg-white">
            <CardHeader>
              ...
              <CardDescription>
                Tier targeting is required when mode is `SELECTED_TIERS`.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border-slate-200 bg-white">
            <CardHeader>
              ...
              <CardDescription>Data source: `GET /api/v1/admin/promotions`.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
