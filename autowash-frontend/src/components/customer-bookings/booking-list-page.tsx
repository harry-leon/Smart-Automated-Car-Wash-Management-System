      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        {bookingsQuery.isPending ? (
          ...
          <Card className="border-rose-200 bg-white">
            <CardHeader>
              <CardTitle>Unable to load bookings</CardTitle>
                ...
                <CardContent className="flex flex-col gap-6 p-6 lg:flex-row lg:items-center lg:justify-between">
                  <div className="space-y-3">
                    ...
                    <div className="grid gap-2 text-sm text-slate-600 md:grid-cols-2">
                      <p>
                        Vehicle: <span className="font-medium text-slate-900">{booking.vehiclePlate}</span>
                      </p>
                      <p>
                        Service: <span className="font-medium text-slate-900">{booking.packageName ?? "--"}</span>
                      </p>
                      <p>
                        Schedule:{" "}
                  ...
                  <div className="flex flex-col items-start gap-3 lg:items-end">
                    ...
                    <Button asChild>
                      <Link href={`/customer/bookings/${booking.bookingId}`}>View detail</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
