...
import { useActiveWashTracking, useCustomerBookingDetail } from "@/hooks/use-bookings";
import { ApplyPointsPanel } from "@/components/customer-bookings/apply-points-panel";
import type { WashTrackingSession } from "@/types/booking.types";
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600 sm:text-base">{copy.subtitle}</p>
              </div>
            </div>
