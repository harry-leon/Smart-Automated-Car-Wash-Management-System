...
VALUES
    ('BK_1716000000201', 'a1c8f8e0-a8d0-4f51-b8d9-a47738b7e28a', 'b1c8f8e0-a8d0-4f51-b8d9-a47738b7e28a', 'pkg_003', null, 'DISCOUNT50K', CURRENT_DATE - 10, '10:00:00', 'E_WALLET', 200000, 100000, 50000, 250000, 65, 'PAID', 'COMPLETED', CURRENT_TIMESTAMP - interval '10' day, null, null),
    ('BK_1716000000202', 'a2c8f8e0-a8d0-4f51-b8d9-a47738b7e28b', 'b2c8f8e0-a8d0-4f51-b8d9-a47738b7e28b', null, 'combo_003', null, CURRENT_DATE - 5, '14:30:00', 'BANK_TRANSFER', 2000000, 0, 0, 2000000, 120, 'PAID', 'COMPLETED', CURRENT_TIMESTAMP - interval '5' day, null, null),
    ('BK_1716000000203', 'a3c8f8e0-a8d0-4f51-b8d9-a47738b7e28c', 'b3c8f8e0-a8d0-4f51-b8d9-a47738b7e28c', 'pkg_004', null, 'SUMMER30', CURRENT_DATE - 2, '09:00:00', 'CASH_AT_COUNTER', 800000, 150000, 285000, 665000, 150, 'PAID', 'COMPLETED', CURRENT_TIMESTAMP - interval '2' day, null, null),
    ...
    ('BK_1716000000205', 'a5c8f8e0-a8d0-4f51-b8d9-a47738b7e28e', 'b5c8f8e0-a8d0-4f51-b8d9-a47738b7e28e', 'pkg_001', null, null, CURRENT_DATE - 1, '08:00:00', 'BANK_TRANSFER', 150000, 0, 0, 150000, 30, 'REFUNDED', 'CANCELLED', CURRENT_TIMESTAMP - interval '1' day, CURRENT_TIMESTAMP, 'Not available')
;
...
VALUES
    ('31111111-1111-1111-1111-000000000201', 'BK_1716000000201', 'COMPLETED', 25, CURRENT_TIMESTAMP - interval '10' day, CURRENT_TIMESTAMP - interval '10' day, CURRENT_TIMESTAMP - interval '10' day, CURRENT_TIMESTAMP - interval '10' day, CURRENT_TIMESTAMP - interval '10' day),
    ('31111111-1111-1111-1111-000000000202', 'BK_1716000000202', 'COMPLETED', 200, CURRENT_TIMESTAMP - interval '5' day, CURRENT_TIMESTAMP - interval '5' day, CURRENT_TIMESTAMP - interval '5' day, CURRENT_TIMESTAMP - interval '5' day, CURRENT_TIMESTAMP - interval '5' day),
    ('31111111-1111-1111-1111-000000000203', 'BK_1716000000203', 'COMPLETED', 66, CURRENT_TIMESTAMP - interval '2' day, CURRENT_TIMESTAMP - interval '2' day, CURRENT_TIMESTAMP - interval '2' day, CURRENT_TIMESTAMP - interval '2' day, CURRENT_TIMESTAMP - interval '2' day)
;

-- 5. Loyalty & Points
INSERT INTO loyalty_accounts (id, customer_id, current_points, tier, created_at, updated_at)
VALUES
    ('41111111-1111-1111-1111-000000000201', 'a1c8f8e0-a8d0-4f51-b8d9-a47738b7e28a', 25, 'MEMBER', CURRENT_TIMESTAMP - interval '10' day, CURRENT_TIMESTAMP - interval '10' day),
    ('41111111-1111-1111-1111-000000000202', 'a2c8f8e0-a8d0-4f51-b8d9-a47738b7e28b', 200, 'SILVER', CURRENT_TIMESTAMP - interval '5' day, CURRENT_TIMESTAMP - interval '5' day),
    ('41111111-1111-1111-1111-000000000203', 'a3c8f8e0-a8d0-4f51-b8d9-a47738b7e28c', 66, 'GOLD', CURRENT_TIMESTAMP - interval '2' day, CURRENT_TIMESTAMP - interval '2' day)
;

INSERT INTO point_transactions (id, customer_id, type, points, balance_after, reason, reference_id, created_at)
VALUES
    ('51111111-1111-1111-1111-000000000201', 'a1c8f8e0-a8d0-4f51-b8d9-a47738b7e28a', 'EARN', 25, 25, 'Wash completed', '31111111-1111-1111-1111-000000000201', CURRENT_TIMESTAMP - interval '10' day),
    ('51111111-1111-1111-1111-000000000202', 'a2c8f8e0-a8d0-4f51-b8d9-a47738b7e28b', 'EARN', 200, 200, 'Wash completed', '31111111-1111-1111-1111-000000000202', CURRENT_TIMESTAMP - interval '5' day),
    ('51111111-1111-1111-1111-000000000203', 'a3c8f8e0-a8d0-4f51-b8d9-a47738b7e28c', 'EARN', 66, 66, 'Wash completed', '31111111-1111-1111-1111-000000000203', CURRENT_TIMESTAMP - interval '2' day)
;
