...
public class GoogleOAuthServiceImpl implements GoogleOAuthService {
    ...
    public String handleCallback(String code, String state) {
        ...
        if (existingOAuth.isPresent()) {
            ...
            existingOAuth.get().updateProfile(googleUser.fullName(), googleUser.avatarUrl());
    ...
    public LoginResponse exchangeTicket(String state) {
        ...
        if (existingOAuth.isPresent()) {
            ...
            oauthAccountRepository.save(new UserOAuthAccount(
                    ...
                    ticket.getProviderSubject(), ticket.getProviderEmail(),
                    ticket.getProviderFullName(), ticket.getProviderAvatarUrl()
            ));
            isNew = true;
        }
    ...
    public LoginResponse confirmLink(String state) {
        ...
        if (!ticket.isLinkRequired() || ticket.getUserId() == null) {
            throw new ApiException(HttpStatus.UNPROCESSABLE_ENTITY,
